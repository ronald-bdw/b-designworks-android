...
public class AdapterDelegatesManager<T> {
     ...
     */
    public int getItemViewType(@NonNull List<? extends T> items, int position) {
     ...
     * viewType
     */
    public void onBindViewHolder(@NonNull List<? extends T> items, int position, @NonNull RecyclerView.ViewHolder viewHolder) {
