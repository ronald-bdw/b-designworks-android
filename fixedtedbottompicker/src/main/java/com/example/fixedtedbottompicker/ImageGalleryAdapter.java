...
public class ImageGalleryAdapter extends
    ...
    Context                      context;
    FixedTedBottomPicker.Builder builder;
    OnItemClickListener          onItemClickListener;

    public ImageGalleryAdapter(Context context, FixedTedBottomPicker.Builder builder) {
        ...
        try {
            ...
            //imageCursor = sContext.getContentResolver()
            // .query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, columns, null, null, orderBy);
    ...
    public GalleryViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = View.inflate(context,
            gun0912.tedbottompicker.R.layout.tedbottompicker_grid_item, null);
    ...
    @Override
    public void onBindViewHolder(final GalleryViewHolder holder,
    ...
    public static class PickerTile {
        ...
        protected final
        @gun0912.tedbottompicker.adapter.ImageGalleryAdapter.PickerTile.TileType
        int tileType;

        PickerTile(@gun0912.tedbottompicker.adapter.ImageGalleryAdapter.PickerTile.SpecialTileType
                       int tileType) {
            this(null, tileType);
        }
        ...
        protected PickerTile(
            @Nullable Uri imageUri,
            @gun0912.tedbottompicker.adapter.ImageGalleryAdapter.PickerTile.TileType int tileType) {
    ...
    class GalleryViewHolder extends RecyclerView.ViewHolder {
        ...
        public GalleryViewHolder(View view) {
            super(view);
            root = (TedSquareFrameLayout) view.findViewById(gun0912.tedbottompicker.R.id.root);
            iv_thumbnail = (TedSquareImageView) view.findViewById(
                gun0912.tedbottompicker.R.id.iv_thumbnail);
